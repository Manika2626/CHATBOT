...
response_dict = {
    ...
    "complaint": "Sorry to hear that! Please describe your concern, we'll try to resolve!",
    "feedback":"We value your feedback! Please share your thoughts and we will try to implement the same in our services!",
    "funfact":"Did you know that honey never spoils? Archaeologists have even found pots of honey in ancient Egyptian tombs that are over 3,000 years old and still perfectly edible!",
    "joke":"Why don't scientists trust atoms? Because they make up everything XD!",
    "thanks":"Your Welcome! Do tell if you need anything else",
    "music":"What genre of music suits your mood? I can recommend songs or artists for you!",
    "appointment":"Sure I can book an appointment for you please share your name and other relevant details like contact number and time!",
}